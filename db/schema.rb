...
ActiveRecord::Schema[7.2].define(version: 2025_08_10_061758) do
  ...
  create_table "convenience_stores", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.integer "convenience_store_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "review_regions", force: :cascade do |t|
    t.bigint "review_id", null: false
    t.bigint "region_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["region_id"], name: "index_review_regions_on_region_id"
    t.index ["review_id"], name: "index_review_regions_on_review_id"
  end
  ...
  create_table "reviews", force: :cascade do |t|
    t.string "convenience_store_name", null: false
  ...
  add_foreign_key "review_regions", "regions"
  add_foreign_key "review_regions", "reviews"
